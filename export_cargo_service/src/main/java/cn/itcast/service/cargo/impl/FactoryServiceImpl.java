...
public class FactoryServiceImpl implements FactoryService {
    ...
    public Factory findByFactoryName(String factoryName) {
        FactoryExample exmpale = new FactoryExample();
        exmpale.createCriteria().andFactoryNameEqualTo(factoryName);
        List<Factory> factoryList = factoryDao.selectByExample(exmpale);
